...
* (3:50) A current project - Support Vector Machine

h2. (4:00) Some Mathematical fun
...
Harry wrote the code below.  Although it is the biggest block of code yet seen, and mathematically complex, it only uses two things that are new to us - both methods of the built in @Math@ object:
...
* Math is singular, not plural, because that is how they say it in America.
